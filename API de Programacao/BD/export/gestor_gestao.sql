...
CREATE TABLE `gestao` (
  ...
  KEY `fk_Funcionario_has_Produto_Funcionario_idx` (`Funcionario_idFuncionario`),
  CONSTRAINT `fk_Funcionario_has_Produto_Funcionario` FOREIGN KEY (`Funcionario_idFuncionario`) REFERENCES `funcionario` (`idFuncionario`),
  CONSTRAINT `fk_Funcionario_has_Produto_Produto` FOREIGN KEY (`Produto_idProduto`) REFERENCES `produto` (`idProduto`)
...
-- Dump completed on 2024-07-24 17:40:25
